<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="BillWiseSales, App_Web_d1qb3zxq" %>
        ...
        <ContentTemplate>
            ...
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Bill WISE SALES SUMMARY REPORT</h2>
                                        ...
                                        <table id="dt" class="table table-bordered table-hover">
                                            <thead>
                                                <tr style="background-color: #2b4570; color: white;">
                                                    <th>
                                                        <asp:Label ID="Label14" runat="server" Text="BILL NO"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label5" runat="server" Text="DATE"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label15" runat="server" Text="VALUE"></asp:Label></th>
                                                </tr>
