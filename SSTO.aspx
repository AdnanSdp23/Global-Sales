<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Admin.master" inherits="SSTO, App_Web_fwlgusei" %>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                     <asp:DropDownList ID="ssDropDownList" ClientIDMode="Static" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ssDropDownList_SelectedIndexChanged">
                                     </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                </div>
        ...
        <script type="text/javascript">
            ...
            function load() {
                ...
                $(function () {
                    ...
                    $("[id$=txtItemId]").autocomplete({
                        source: function (request, response) {
                            ...
                            $.ajax({
                                url: '<%=ResolveUrl("~/SSTO.aspx/GetItems") %>',
                    ...
                    $("[id$=txtItemName]").autocomplete({
                        source: function (request, response) {
                            var areacode = $("#txtAreaCode").text();
                            $.ajax({
                                url: '<%=ResolveUrl("~/SSTO.aspx/GetItemsName") %>',
                                data: "{ 'prefix': '" + request.term + "',areacode:'" + areacode + "'}",
                                dataType: "json",
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                ...
                function CheckItemID(Id) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "SSTO.aspx/CheckItem",
                        data: "{itemid:'" + itemid + "',sscode:'" + sscode + "',areacode:'" + areacode + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                function LoadDR() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "SSTO.aspx/LoadDR",
                        data: "{sscode:'" + sscode + "',distcode:'" + distcode + "',status:'" + status + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: function (response) {
                ...
                function SaveOK() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "SSTO.aspx/SaveY",
                        data: "{sscode:'" + sscode + "',distcode:'" + distcode + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                function SaveDR() {
                    var sscode = $("#ssDropDownList :selected").val();
                    var distid = $("#distDropDownList :selected").val();
                    ...
                    $.ajax({
                        type: "POST",
                        url: "SSTO.aspx/SaveImpTO",
                        data: "{sscode:'" + sscode + "',distid:'" + distid + "',itemid:'" + itemid + "',itemname:'" + itemname + "',qty:'" + qty + "',sam_qty:'" + sam_qty + "',landingprice:'" + landingprice + "',itemclass:'" + itemclass + "',itemsubclass:'" + itemsubclass + "',trndate:'" + trndate + "',itemgroup:'" + itemgroup + "' }",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: OnSuccessDR,
