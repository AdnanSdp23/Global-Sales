<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Admin.master" inherits="ImpTI, App_Web_d1qb3zxq" %>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="impDropDownList" ClientIDMode="Static" runat="server" CssClass="form-control input-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:HiddenField ClientIDMode="Static" ID="hfCustomerId" runat="server" />
                                </div>
                                <div class="col-md-6">
                                    <span id="lblFactor" style="color: BlueViolet; font-size: 11px;"></span>
                                    <span id="lblstock" style="color: red; font-size: 11px;"></span>
                                    <span id="lblamntstk" style="color: red; font-size: 11px;"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span id="lblitemgroup" style="color: BlueViolet; font-size: 11px;"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <%--<input type="text" name="txtLandingPrice" id="txtLandingPrice"   style="display:none" class="form-control input-sm" /></td>--%>
                                </div>
                            </div>
                        </div>
                               <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            $(function () {
                ...
                $("[id$=txtItemId]").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: '<%=ResolveUrl("~/ImpTI.aspx/GetItems") %>',
            ...
            function CheckItemID(Id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ImpTI.aspx/CheckItem",
                    data: "{itemid:'" + itemid + "',areacode:'" + areacode + "',impcode:'" + impcode + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
            ...
            function LoadDR() {
                ...
                $.ajax({
                    type: "POST",
                    url: "ImpTI.aspx/LoadDR",
                    data: "{importercode:'" + importercode + "',status:'" + status + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
                    success: function (response) {
            ...
            function OnSuccessDR(response) {
                ...
                var row = "<table border='1' style='background:#FFFFFF;'><tr><td>Item ID</td><td>Item Name</td><td>Qty</td><td>Sam_Qty</td><td>Price</td></tr>";
                var len = response.d.length;
                for (var i = 0; i < len; i++) {
            ...
            function SaveOK() {
                ...
                $.ajax({
                    type: "POST",
                    url: "ImpTI.aspx/SaveY",
                    data: "{importercode:'" + importercode + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
            ...
            function SaveDR() {
                ...
                $.ajax({
                    type: "POST",
                    url: "ImpTI.aspx/SaveImpTI",
                    data: "{importercode:'" + importercode + "',itemid:'" + itemid + "',itemname:'" + itemname + "',qty:'" + qty + "',sam_qty:'" + sam_qty + "',landingprice:'" + landingprice + "',itemclass:'" + itemclass + "',itemsubclass:'" + itemsubclass + "',trndate:'" + trndate + "',itemgroup:'" + itemgroup + "' }",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
                    success: OnSuccessDR,
            ...
            $(document).ready(function () {
                $("[id$=txtItemId]").change(function () {
                    CheckItemID($("[id$=txtItemId]").val());
                });
            });
        }
    </script>
