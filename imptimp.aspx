<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="imptimp, App_Web_d1qb3zxq" %>
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            function LoadDR() {
                ...
                $.ajax({
                    type: "POST",
                    url: "imptimp.aspx/LoadDR",
                    data: "{impcode:'" + impcode + "',trnno:'" + trnno + "'}",
                    ...
                    success: function (response) {
                        ...
                        if (v.length > 0) {
                            ...
                            for (var i = 0; i < len; i++) {
                                ...
                                row = row + "<tr class='bg-info'><td style='display:none;'>" + OID + "</td><td class='id'>" + imptcode + "</td><td class='id'>" + ItemID + "</td><td>" + ItemName + "</td><td class='qty'>" + Qty + "</td><td class='qty'>" + Sam_Qty + "</td><td class='qty'>" + Landing_Cost + "</td></tr>";
            ...
            function SaveOK() {
                ...
                $.ajax({
                    type: "POST",
                    url: "imptimp.aspx/SaveY",
                    data: "{trnno:'" + trnno + "',impcode:'" + impcode + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
