<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="Summary_SRWise, App_Web_fwlgusei" %>
        ...
        <ContentTemplate>
            ...
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">SR WISE SALES SUMMARY REPORT</h2>
                                        ...
                                        <table id="dt" class="table table-bordered table-hover">
                                            <thead>
                                                <tr style="background-color: #2b4570; color: white;">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label10" runat="server" Text="Aug-19"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label9" runat="server" Text="Jul-19"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label8" runat="server" Text="Jun-19"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label7" runat="server" Text="May-19"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label6" runat="server" Text="Apr-19"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label4" runat="server" Text="Mar-19"></asp:Label></th>
                                                    <th>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label2" runat="server" Text="Feb-18"></asp:Label></th>
                                                    <th>
