<%@ page language="C#" autoeventwireup="true" inherits="d_damage_entry, App_Web_edp0we5m" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="box">
            ...
            <fieldset style="width: 336px;">
                <legend style="color: white">Damage Entry</legend>
                <table style="width: 99%; margin-top: 5px;">
                    ...
                    <tr>
                        ...
                        <td class="auto-style4" colspan="2">
                            ...
                            <asp:Label ID="Label73" runat="server" Text="*" ForeColor="Red"></asp:Label><br />
                    ...
                    <tr>
                        <td class="auto-style4">
                            ...
                            <asp:TextBox ID="txtqty" runat="server" Height="24px" Width="100px"></asp:TextBox>
