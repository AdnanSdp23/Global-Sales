<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="Summary_BUWise, App_Web_d1qb3zxq" %>
        ...
        <ContentTemplate>
            ...
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Business wise Sales Summary Report</h2>
                                        ...
                                        <table id="dt" class="table table-bordered table-hover">
                                            <thead>
                                                <tr style="background-color: #2b4570; color: white;">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label16" runat="server" Text="Business Name"></asp:Label></th>
                                                    <th>
