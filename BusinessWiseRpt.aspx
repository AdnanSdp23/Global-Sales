<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="BusinessWiseRpt, App_Web_d1qb3zxq" %>
        ...
        <ContentTemplate>
            ...
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">BUSINESS WISE SALES</h2>
                                        ...
                                        <table id="dt" class="table table-bordered table-hover">
                                            <thead>
                                                <tr style="background-color: #2b4570; color: white;">
                                                    <th>
                                                        <asp:Label ID="Label7" runat="server" Text="Importer Name"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label6" runat="server" Text="Dist Name"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label5" runat="server" Text="Business Name"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label3" runat="server" Text="Business Code"></asp:Label></th>
                                                    <th>
