<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="DistTO, App_Web_fwlgusei" %>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                     <asp:DropDownList ID="distDropDownList" ClientIDMode="Static" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="distDropDownList_SelectedIndexChanged">
                                     </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <label for="email">Retail Code-Name:</label>
                                </div>
                                <div class="col-md-6">
                                     <asp:DropDownList ID="retailDropDownList" ClientIDMode="Static" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="retailDropDownList_SelectedIndexChanged">
                                        </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="txtItemId" id="txtItemId" class="form-control input-sm" />
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <label for="email">Landing Price:</label>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="txtLandingPrice" id="txtLandingPrice" class="form-control input-sm" />
                                </div>
                                <div class="col-md-6">
                                </div>
                            </div>
                      ...
                      <div class="col-md-6">
                           <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <div class="col-md-5">
                                    <input placeholder="Reference No" type="text" name="txtRefNo" id="txtRefNo" class="form-control input-sm" display: none;/>                                 
                                </div>
                                <div class="col-md-5">
        ...
        <script type="text/javascript">
            ...
            function load() {
                ...
                $(function () {
                    ...
                    $("[id$=txtItemId]").autocomplete({
                        source: function (request, response) {
                            ...
                            $.ajax({
                                url: '<%=ResolveUrl("~/DistTO.aspx/GetItems") %>',
                    ...
                    $("[id$=txtItemName]").autocomplete({
                        source: function (request, response) {
                            var areacode = $("#txtAreaCode").text();
                            $.ajax({
                                url: '<%=ResolveUrl("~/DistTO.aspx/GetItemsName") %>',
                                data: "{ 'prefix': '" + request.term + "',areacode:'" + areacode + "'}",
                                dataType: "json",
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                    ...
                    $("#btnSave").click(function () {
                        ...
                        if ($("#distDropDownList :selected").val() === "") {
                            alert("Plz select SS");
                        }
                        else if ($("#retailDropDownList :selected").val() === "") {
                ...
                function CheckItemID(Id) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "DistTO.aspx/CheckItem",
                        data: "{itemid:'" + itemid + "',distcode:'" + distcode + "',areacode:'" + areacode + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                function LoadDR() {
                    ...
                    var distcode = $("#distDropDownList :selected").val();
                    var rtlcode = $("#retailDropDownList :selected").val();
                    var status = 'N';
                    $.ajax({
                        type: "POST",
                        url: "DistTO.aspx/LoadDR",
                        data: "{distcode:'" + distcode + "',rtlcode:'" + rtlcode + "',status:'" + status + "',impcode:'" + impcode + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: function (response) {
                            var v = response.d;
                            if (v.length > 0) {
                                var row = "<table class='table table-responsive table-bordered' id='tblDR' border='1' style='background:#FFFFFF;font-size:10px;'><tr><td>Item ID</td><td>Item Name</td><td>Qty</td><td>Sam_Qty</td><td>Price</td><td>Action</td></tr>";
                ...
                function OnSuccessDR(response) {
                    ...
                    var row = "<table border='1' style='background:#FFFFFF;'><tr><td>Item ID</td><td>Item Name</td><td>Qty</td><td>Sam_Qty</td><td>Price</td><td>Action</td></tr>";
                    var len = response.d.length;
                    for (var i = 0; i < len; i++) {
                        ...
                        row = row + "<tr><td>" + OID + "</td><td>" + ItemID + "</td><td>" + ItemName + "</td><td>" + Qty + "</td><td>" + Sam_Qty + "</td><td>" + Landing_Cost + "</td></tr>";
                    }
                ...
                function SaveOK() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "DistTO.aspx/SaveY",
                        data: "{distcode:'" + distcode + "',rtlcode:'" + rtlcode + "',RefNo:'" + RefNo + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                function SaveDR() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "DistTO.aspx/SaveImpTO",
                        data: "{distcode:'" + distcode + "',rtlcode:'" + rtlcode + "',itemid:'" + itemid + "',itemname:'" + itemname + "',qty:'" + qty + "',sam_qty:'" + sam_qty + "',landingprice:'" + landingprice + "',itemclass:'" + itemclass + "',itemsubclass:'" + itemsubclass + "',trndate:'" + trndate + "',itemgroup:'" + itemgroup + "' }",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: OnSuccessDR,
