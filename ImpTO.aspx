<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Admin.master" inherits="ImpTO, App_Web_d1qb3zxq" %>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                     <input type="text" name="txtSSDIST" id="txtSSDIST" class="form-control input-sm" />
                                ...
                                <div class="col-md-6">
                                     <span id="lblDistCode" style="color: BlueViolet; font-size: 11px;"></span>
                                    <span id="lblBaseName" style="color: BlueViolet; font-size: 11px;"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-6">
                           <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <div class="col-md-5">
                                     <input type="button" value="Save All" class="btn btn-primary" id="btnActiveAll" display: none;" />
                                </div>
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            $(function () {
                ...
                $("[id$=txtSSDIST]").autocomplete({
                    source: function (request, response) {
                        var impcode = $("#impDropDownList :selected").val();
                        var trnno = $("#TRNDropDownList :selected").val();
                        var areacode = $("#txtAreaCode").text();
                        $.ajax({
                            url: '<%=ResolveUrl("~/ImpTO.aspx/GetDist") %>',
                            data: "{ 'prefix': '" + request.term + "',impcode: '" + impcode + "',trnno:'" + trnno + "',areacode:'" + areacode + "'}",
                            dataType: "json",
                            type: "POST",
                            ...
                            failure: function (response) {
                              ...
                              select: function (e, i) {
                                  CheckDist(i.item.val);
                                  $("[id$=txtSSDIST]").val(i.item.label);
                              },
                              minLength: 1
                          });

                $("#txtSSDIST").change(function () {
                    CheckDist(i.item.val);
                });
            ...
            function CheckDist(Id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ImpTO.aspx/CheckDist",
                    data: "{Distid:'" + Distid + "',impcode:'" + impcode + "',trnno:'" + trnno + "',areacode:'" + areacode + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
                    success: OnSuccessDist,
                    failure: function (response) {
                        $("#lblDistCode").text('');
                        $("#lblBaseName").text('');
                    }
            ...
            function OnSuccessDist(response) {
                var v = response.d;
                var tempArr = v.split(',');
                $("#lblDistCode").text(tempArr[0]);
                $("#lblBaseName").text(tempArr[1]);
            }
            ...
            function LoadDR() {
                ...
                var impoutdistid = $("#lblDistCode").text();
                var trnno = $("#TRNDropDownList :selected").val();
                var status = 'N';
                $.ajax({
                    type: "POST",
            ...
            function SaveOK() {
                ...
                $.ajax({
                    ...
                    data: "{trnname:'" + trnname + "',importercode:'" + importercode + "',impoutdistid:'" + impoutdistid + "',RefNo:'" + RefNo + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
            ...
            function SaveDR() {
                var importercode = $("#impDropDownList :selected").val();
                var trnname = $("#TRNDropDownList :selected").val();
                var impoutssid = $("#lblDistCode").text();
