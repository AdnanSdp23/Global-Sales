<%@ page title="" language="C#" masterpagefile="~/Admin.master" autoeventwireup="true" inherits="RTLTI, App_Web_d1qb3zxq" %>
                ...
                <div class="col-md-6">
                    <form>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <label for="email">Retailer Code-Name:</label>
                                </div>
                                <div class="col-md-6">
                                     <asp:DropDownList ID="rtlDropDownList" ClientIDMode="Static" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ssDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                </div>
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            $(function () {
                ...
                $("#btnSave").click(function () {
                    ...
                    if ($("#senderDropDownList :selected").val() === "") {
                        ...
                        alert("Plz Select Dist");
                    }
                    else if ($("#rtlDropDownList :selected").val() === "") {
                        alert("Plz Select Retailer");
                    }
            ...
            function LoadDR() {
                ...
                var rtlcode = $("#rtlDropDownList :selected").val();
                var trnno = $("#TrnNoDropDownList :selected").val();
                $.ajax({
                    type: "POST",
                    url: "RTLTI.aspx/LoadDR",
                    data: "{rtlcode:'" + rtlcode + "',trnno:'" + trnno + "',sender:'" + sender + "'}",
            ...
            function SaveOK() {
                ...
                $.ajax({
                    type: "POST",
                    url: "RTLTI.aspx/SaveY",
                    data: "{trnno:'" + trnno + "',rtlcode:'" + rtlcode + "',sender:'" + sender + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
